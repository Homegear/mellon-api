...
class Sqlite3 {
 public:
  Sqlite3();
  Sqlite3(const std::string& databasePath, std::string databaseFilename, bool databaseSynchronous, bool databaseMemoryJournal, bool databaseWalJournal);
  ~Sqlite3();
  void dispose();
  void init(const std::string& databasePath, std::string databaseFilename, bool databaseSynchronous, bool databaseMemoryJournal, bool databaseWalJournal, std::string backupPath = "", std::string backupFilename = "");
  void hotBackup();
